import { Controller, Post, Body, UseGuards, Get, Param, ParseIntPipe, Patch, Delete, Query } from '@nestjs/common';
...
export class CitizensController {
  ...
  @Get(':id')
  @UseGuards(RolesGuard('admin', 'supervisor'))
  findOne(@Param('id', ParseIntPipe) id: number, @User() user, @MaybeSupervisor() sup?: any) {
    const effectiveUser = sup ?? user;
  ...
  @Patch(':id')
  @UseGuards(RolesGuard('admin'))
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateCitizenDto, @User() user) {
